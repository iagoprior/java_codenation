...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withPontos(int pontos) {
            if(pontos < 0)
            {
                throw new IllegalArgumentException("Não pode ter pontos negativos");
            }
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
            if(nome.isEmpty())
            {
                throw new NullPointerException("O motorista deve ter nome");
            }

            if(habilitacao == null)
            {
                throw new NullPointerException("Não tem habilitação");
            }
